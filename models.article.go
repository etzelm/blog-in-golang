...
func getAllArticles() []article {
	...
	err = c.Insert(&article{ID: 1, Title: "Article 1", Blurb: "Intro 1", Content: "Article 1 body"},
		...
		&article{ID: 37, Title: "Article 3", Blurb: "Intro 3", Content: "Article 3 body"},
		...
		&article{ID: 28, Title: "Article 8", Blurb: "Intro 8", Content: "Article 8 body"},
		...
		&article{ID: 71, Title: "Article 11", Blurb: "Intro 11", Content: "Article 11 body"},
		...
		&article{ID: 214, Title: "Article 14", Blurb: "Intro 14", Content: "Article 14 body"},
		&article{ID: 15, Title: "Article 15", Blurb: "Intro 15", Content: "Article 15 body"},
		&article{ID: 116, Title: "Article 16", Blurb: "Intro 16", Content: "Article 16 body"},
		...
		&article{ID: 99, Title: "Article 19", Blurb: "Intro 19", Content: "Article 19 body"})
	if err != nil {
		log.Fatal(err)
	}

	err = c.Insert(&article{ID: 9999, Title: "About Me", Blurb: "Just a quick blurb about me and this blog",
		Content: "<br><br><br><br><br><br><br>" +
			"<img src=\"/public/face.jpg\" alt=\"My Face\">"})
	if err != nil {
		log.Fatal(err)
	} */
